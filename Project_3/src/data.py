...
#     data_transforms = {
#         "train": transforms.Compose([transforms.Resize(256),# YOUR CODE HERE
...
#         "valid": transforms.Compose([transforms.Resize(224),# YOUR CODE HERE
#                                     transforms.ToTensor(),
#                                     transforms.Normalize(mean, std)]),
        
       
#         "test": transforms.Compose([transforms.Resize(224),# YOUR CODE HERE
#                                     transforms.ToTensor(),
#                                     transforms.Normalize(mean, std)])
#     }
    data_transforms = {
