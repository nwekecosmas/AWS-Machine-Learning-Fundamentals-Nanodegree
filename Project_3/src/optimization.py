...
# suggested optimizer: optimizer = AdamW(model.parameters(), lr=2.6e-4, weight_decay=1e-4)
# suggested lr scheduler: scheduler = CosineAnnealingLR(optimizer, T_max=num_epochs)
...
def get_optimizer(
    ...
    :param optimizer: one of 'SGD' or 'AdamW'
    ...
    if optimizer == "sgd":
        ...
        # and weight_decay
        opt = torch.optim.SGD(model.parameters(), # YOUR CODE HERE
                              lr=learning_rate,
                              momentum=momentum,
        ...
        # YOUR CODE HERE: create an instance of the Adamw
        # optimizer. Use the input parameters learning_rate, momentum
        # and weight_decay # YOUR CODE HERE
...
def test_get_optimizer_returns_adamw(fake_model):
    ...
    opt = get_optimizer(fake_model, optimizer="adamw")
...
def test_get_optimizer_sets_learning_rate(fake_model):
    ...
    opt = get_optimizer(fake_model, optimizer="adamw", learning_rate=0.123)
